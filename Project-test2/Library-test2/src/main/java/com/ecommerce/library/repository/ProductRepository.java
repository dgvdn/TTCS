...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	@Query(value = "select * from products p where p.is_deleted = false and p.is_activated = true and p.category_id = ?1 limit 4", nativeQuery = true)
	List<Product> getHomeList(Long categoryId);
